...
const schema={
  ...
  required:["understood","goal","intent","domain","solution_scope","urgency","needs_location","clarification","passport_search","external_searches","safety","result_strategy"],
  properties:{
